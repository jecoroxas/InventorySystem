		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-success button1" data-toggle="modal" data-target="#addLocationModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Location </button>
				</div> <!-- /div-action -->				
				
				<table class="table table-hover table-striped table-bordered" id="manageLocationTable">
					<thead>
						<tr>							
							<th>Location</th>
							<th>Status</th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitLocationForm" action="php_action/createLocation.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="locationName" placeholder="Location Description" name="locationName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	        <div class="form-group">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-success" id="createLocationBtn" data-loading-text="Loading..." autocomplete="off">Save Changes</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
...
<!-- edit brand -->
<div class="modal fade" id="editLocationModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-location-result">
		      	<div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editLocationName" placeholder="Location Description" name="editLocationName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
